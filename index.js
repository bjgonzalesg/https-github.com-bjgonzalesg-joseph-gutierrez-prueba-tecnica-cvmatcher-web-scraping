...
const main = async () => {
  ...
  const url =
    "https://www.laborum.pe/job/BCP---Otras-posiciones/Practicante-Pre-Profesional/67a6138fb3e5207fb22e0d56";
  ...
  for (const item of items) {
    ...
    const enterprise =
      enterpriseElement && (await enterpriseElement.textContent());
    ...
    const publishedAt =
      publishedAtElement && (await publishedAtElement.textContent());
    ...
    const description =
      descriptionElement && (await descriptionElement.textContent());
